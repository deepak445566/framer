  ...
  return (
    <div className="p-6 max-w-lg">
      <div className="bg-white rounded-lg shadow p-6">
        <h2 className="text-xl font-semibold mb-4">Edit Driver Profile</h2>
        ...
        <form onSubmit={handleSubmit} className="space-y-3">
          ...
          <input name="vehicleNo" placeholder="Vehicle Number" value={form.vehicleNo} onChange={handleChange} className="w-full border rounded px-3 py-2" required />
